										...
										<div class="col-lg-7">
											...
											<div class="row g-3 mb-4">
		                                       ...
		                                       <div class="form-group col-6">
						                        ...
						                        <div class="form-group col-6">
						                            <label for="icon" class="pb-2 w-100">{{ __('category.field_category_icon_color') }}</label>
							                        @if($category->icon_color)
													    <img class="contract-page__icon" src="{{ asset('storage/' . $category->icon_color) }}" alt="{{ $category->name }}">
													@else
													    <img class="contract-page__icon" src="{{ asset('assets/images/no-image.svg') }}" alt="Placeholder Image">
													@endif
