		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3 border-none font-18 ps-2">{{ __('category.create_title') }}</div>
					<div class="ps-3">
					</div>
				 	<div class="ms-auto">
					...
					<div class="card card-bordered">
						<div class="card-body p-5">
							<div class="row justify-between d-flex justify-content-between">
											...
											<div class="row g-3 mb-4">
		                                       ...
		                                       <div class="form-group col-6">
						                        ...
						                        <div class="form-group col-6">
						                            ...
						                            <input type="text" name="name_sv" id="name_swedish" class="form-control" required>
						                        </div>

						                        <div class="form-group col-6">
						                            <label for="sort" class="pb-2">{{ __('category.field_category_sort') }}</label>
						                            <input type="number" name="sort" id="sort" class="form-control" required>
						                        </div>
						                        ...
						                        <div class="form-group col-6">
						                            <label for="icon" class="pb-2">{{ __('category.field_category_icon') }}</label>
		                                       		<input type="file" name="icon" id="icon" class="form-control-file">
						                        </div>
						                        <div class="form-group col-6">
						                            <label for="icon_color" class="pb-2">{{ __('category.field_category_icon_color') }}</label>
		                                       		<input type="file" name="icon_color" id="icon_color" class="form-control-file">
						                        </div>
		                                    </div>
										</div>
											...
											<div class="row g-3 mb-4">
												<div id="subcategories-container" class="subcategories-container">
						                            <div class="subcategory-row d-flex gap-3 pb-2">
						                            	<span class="p-relative w-100"><img class="subcategory-row__flag" src="{{ asset('assets/flags/4x3/gb.svg') }}" alt="English Flag" width="20"><input value="" type="text" name="subcategories_name[]" placeholder="Name" class="form-control"></span>
											            <span class="p-relative w-100"><img class="subcategory-row__flag" src="{{ asset('assets/flags/4x3/se.svg') }}" alt="Swedish Flag" width="20"><input value="" type="text" name="subcategories_name_sv[]" placeholder="Name (Swedish)" class="form-control"></span>
                        		...
                        		<button type="submit" class="btn btn-primary">{{ __('category.save_category') }}</button>
								</form>
							</div>
						</div>
					</div>
