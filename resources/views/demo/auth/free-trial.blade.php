...
@section('content')
  <!--wrapper-->
    <div class="wrapper">
        <div class="section-authentication-signin trial d-flex align-items-center justify-content-center my-5 my-lg-0">
            <div class="container">
                                ...
                                <div class=" p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <label for="inputCompName" class="form-label">Företagsnamn*</label>
                                                <input type="text" class="form-control" id="inputCompName" placeholder="">
                                            </div>
                                            <div class="col-6">
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-center mt-5 mb-5">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label" for="flexSwitchCheckChecked">Genom att skapa ett gratiskonto på Kontroll.se så accepterar jag era <a href="https://kontroll.se/allmanna-villkor" target="_blank">allmänna villkor</a></label>
                                                    </div>
                                                </div>
                                                <div class="d-flex justify-content-center">
                                                    <button type="submit" class="btn btn-primary basic-card__btn">TESTA GRATIS</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class=" basic-card__second">
                            <div class="card-body pt-0">
                                <div class=" p-0 rounded">
                                    <div class="text-center">
                                        <h3 class="basic-card__sectitle">Testa Kontroll.se</h3>
                                    </div>
                                    <div class="basic-card__seccontent">
