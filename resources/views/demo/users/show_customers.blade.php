			                                        	...
			                                        	<div class="col-lg-12">
															<div class="row g-3 mb-4">
						                                        <div class="col-6 col-lg-6 ps-4">
						                                            ...
						                                            <input type="text" required name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $customer->ownedCompany->name) }}" id="Company" placeholder="{{ __('company.fields.company_name') }}">
						                                            @error('name')
