                            ...
                            <div class="card h-100" style="border-color:{{ $folder->color  }}" onmouseover="this.style.background='{{ $folder->color  }}'" onmouseout="this.style.background='#fff'">
                                <div class="card-body">
                                    <div class="card-body__titlewrap">
                                        <div class="card-body__typeicon widgets-icons-2 rounded-circle text-white m-auto mt-3 mb-3" style="background-color:{{ $folder->color  }}">

                                            <img src="{{ asset('storage/' . $folder->icon) }}">
                                        </div>
                                        <h5 class="card-title text-center" style="color:{{ $folder->color  }}">{{ $folder->name }} </h5>
