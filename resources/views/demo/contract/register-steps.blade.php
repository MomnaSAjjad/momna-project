                                ...
                                <div class="bs-stepper-content step-content">
                                            ...
                                            <div class="row g-3 pe-2 ps-2 pb-2">
                                                <div class="col-12 col-lg-12"> 
                                                    <div class="col-6 col-lg-6 mb-3">
                                                        <span class="border px-2 py-1 rounded fs-08" style="border-color:{{ $folder->color }}!important;color:{{ $folder->color }}">{{ $folder->name }}</span>
                                                ...
                                                <div class="col-6 col-lg-6">
                                                    ...
                                                    <input name="contract_name" type="text" class="form-control" id="ContractName" placeholder="Title" required>
                                                </div>
                                                <div class="col-6 col-lg-6 ContractTypeOptionalGroup" style="display:none;">
                                                    <input name="ContractTypeOptional" type="text" class="form-control" id="ContractTypeOptional" placeholder="{{ __('contracts.steps_page.fields.contract_optional_title') }}" required>
                                                </div>
                                                <hr class="mt-5">
                                                <div class="col-6 col-lg-6">
                                                    ...
                                                    <select name="contract_owner" class="form-select" id="ContractOwner" aria-label="ContractOwner">
                                                        <option disabled selected>{{ __('general.select') }}</option>
                                                ...
                                                <div class="col-6 col-lg-6 mt-4">
                                                    ...
                                                    <input name="contract_telephone" type="text" class="form-control" id="ContractTelephone" readonly placeholder="Number">
                                                </div>
                                                <div class="col-6 col-lg-6 mt-4">
                                                    <label for="ContractEmail" class="form-label">{{ __('contracts.steps_page.fields.contract_email') }}</label>
                                                    <input name="contract_email" type="text" class="form-control" id="ContractEmail" readonly placeholder="Email">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <form name="frmSecondStep" id="frmSecondStep">
                                            ...
                                            <div class="row g-3 pe-2 ps-2 pt-4">
                                                <div class="col-6 col-lg-6">
                                                    ...
                                                    <input name="amount_value" type="text" class="form-control" id="AmountValue" placeholder="Price" required>
                                                </div>
                                                <div class="col-6 col-lg-6">
                                                ...
                                                <!-- <div class="row  mt-3"> -->
                                                    <div class="col-6 col-lg-6">
                                                        <div class="text-left">
                                                            ...
                                                            <div class="datepicker-wrap">
                                                                <input name="duration_start_date" id="DurationStartDate" placeholder="Valid From" class="form-control text-left datepicker" type="text" required />
                                                    ...
                                                    <div class="col-6 col-lg-6">
                                                        <div class="text-left">
                                                            ...
                                                            <div class="datepicker-wrap">
                                                                <input name="duration_end_date" id="DurationEndDate" placeholder="Valid To" class="form-control text-left datepicker" type="text" required/>
                                                                <i class='bx bx-calendar'></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <form name="frmFifthStep" id="frmFifthStep">
                                            <div class="row g-3 pe-2 ps-2 mb-4">
                                                <div class="col-6 col-lg-6">
                                                    ...
                                                    <input name="counterparty_company_name" type="text" required class="form-control" id="CounterpartyCompanyName" placeholder="Name" required>
                                                </div>
                                                <hr class="mt-5">
                                                <div class="col-6 col-lg-6">
                                                    <label for="CounterpartyPersonName" class="form-label">{{ __('contracts.steps_page.fields.counterparty_person') }}</label>
                                                    <input name="counterparty_person_name" type="text" class="form-control" id="CounterpartyPersonName" placeholder="Name">
                                                </div>
                                                <div class="col-6 col-lg-6">
                                                    <label for="CounterpartyEmail" class="form-label">{{ __('contracts.steps_page.fields.counterparty_email') }}</label>
                                                    <input name="counterparty_email" type="text" class="form-control" id="CounterpartyEmail" placeholder="Email">
                                                </div>
                                                <div class="col-6 col-lg-6 mt-4">
                                                    <label for="CounterpartyTelephone" class="form-label">{{ __('contracts.steps_page.fields.counterparty_phone') }}</label>
                                                    <input name="counterparty_telephone" type="text" class="form-control" id="CounterpartyTelephone" placeholder="Number">
                                                </div>
                                                <div class="col-6 col-lg-6 mt-4">
                                                    <label for="CounterpartyWorkTelephone" class="form-label">{{ __('contracts.steps_page.fields.counterparty_work_phone') }}</label>
                                                    <input name="counterparty_work_telephone" type="text" class="form-control" id="CounterpartyWorkTelephone" placeholder="Number">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <form name="frmSeventhStep" id="frmSeventhStep">
                                            <div class="row g-3">
                                                <div class="col-12 col-lg-12">
                                                    ...
                                                    <textarea name="comment_area" id="CommentArea" type="textarea" class="form-control mb-4 textarea" rows="6" placeholder="Type Here.."></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="steps-buttons-wrapper">
                                        <div class="steps-buttons step-footer">
                                            ...
                                            <button data-step-action="next" class="step-btn btn btn-primary next-btn">{{ __('general.next_button') }}</button>
                                           <button data-step-action="finish" class="step-btn btn btn-primary finish save-all-steps">{{ __('general.finish_button') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            //     $('.PaymentPeriodExplanation').removeClass('d-none');
            //     if($(this).val() == 1){
            //         $('.PaymentPeriodExplanation p').html("Annual Price");
            //     }
            //     if($(this).val() == 2){
            //         $('.PaymentPeriodExplanation p').html("Fixed Monthly Price");
            //     }
            //     if($(this).val() == 3){
            //         $('.PaymentPeriodExplanation p').html("Variable Monthly Price");
            //     }
            //     if($(this).val() == 4){
            //         $('.PaymentPeriodExplanation p').html("Quarterly Price");
            //     }
            //     if($(this).val() == 5){
            //         $('.PaymentPeriodExplanation p').html("Fixed and Variable Price");
            //     }
            // });
            $('#ReminderDate').change(function() {
            ...
            $('.next-btn, .prev-btn, .step').click(function() {
                ...
                // if($('.step-reminder').hasClass('active')){
                //     $('.next-btn').text('Skip');
                // }else{
            ...
            $('#ContractType').change(function() {
                if($(this).val() == 'optional'){
                    $('.ContractTypeOptionalGroup').show(100);
                }else{
                    $('.ContractTypeOptionalGroup').hide(100);
                }
            });
