		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-end mb-3">
					<div class="breadcrumb-title pe-3 border-none font-15 ps-2">{{__('messages.User Profile')}}</div>
					<div class="ps-3">
					</div>
				 	<div class="ms-auto d-flex align-items-center">
                        <a href="{{ url('/users') }}" class="btn btn-secondary pe-4 ps-4 me-0">{{__('messages.Back')}}</a>
				 		<a href="#" class="btn btn-primary radius-20 mt-2 mt-lg-0 ms-2 px-3">{{__('messages.Save Changes')}}</a>
				 	</div>
				</div>
			</div>
                        ...
                        <div class="main-body">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="card card-bordered">
                                        <div class="card-body">
                                            <h5 class="d-flex align-items-center mb-3 font-16">{{__('messages.Permissions')}}</h5>
                                             <div class="col-12 col-lg-12 mb-4">
                                                <label for="UserType" class="form-label">{{__('messages.User Type')}}</label>
                                                <select class="form-select" id="UserType" aria-label=".form-select-sm example">
                                                    <option disabled selected hidden value="">{{__('messages.Manager')}}</option>
                                                    <option value="1">{{__('messages.Administrator')}}</option>
                                                    <option value="2">{{__('messages.Manager')}}</option>
                                                </select>
                                            </div>
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission1">
                                                                {{__('messages.Add, Edit or Delete users and select rights')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission2">
                                                                {{__('messages.Register and upload contracts')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission5">
                                                                {{__('messages.Receive email reminders')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission6">
                                                                {{__('messages.See contract costs')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission8">
                                                                {{__('messages.See all Categories')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap ps-1">
                                                        <div class="form-check form-check-success">
                                                            ...
                                                            <label class="form-check-label" for="Permission9">
                                                                {{__('messages.See Contracts in Archive')}}
                                                            </label>
                                                        </div>
                                                    </li>
                                ...
                                <div class="col-lg-8">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3 mb-4">
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Title" class="form-label">{{__('messages.Company')}}</label>
                                                    <input type="text" required="" class="form-control" id="Company" placeholder="{{__('messages.Company')}}">
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Title" class="form-label">{{__('messages.Region')}}</label>
                                                    <select class="form-select" id="Region" aria-label=".form-select-sm example">
                                                        <option disabled selected hidden value="">{{__('messages.Select')}}</option>
                                                        <option value="1">{{__('messages.Blekinge')}}</option>
                                                        <option value="2">{{__('messages.Dalarna')}}</option>
                                                        <option value="3">{{__('messages.Gotland')}}</option>
                                                        <option value="4">{{__('messages.Gävleborg')}}</option>
                                                        <option value="5">{{__('messages.Halland')}}</option>
                                                        <option value="6">{{__('messages.Jämtland')}}</option>
                                                        <option value="7">{{__('messages.Jönköping')}}</option>
                                                        <option value="8">{{__('messages.Kalmar')}}</option>
                                                        <option value="9">{{__('messages.Kronoberg')}}</option>
                                                        <option value="10">{{__('messages.Norrbotten')}}</option>
                                                        <option value="11">{{__('messages.Skåne')}}</option>
                                                        <option value="12">{{__('messages.Stockholm')}}</option>
                                                        <option value="13">{{__('messages.Sörmland')}}</option>
                                                        <option value="14">{{__('messages.Uppsala')}}</option>
                                                        <option value="15">{{__('messages.Värmland')}}</option>
                                                        <option value="16">{{__('messages.Västerbotten')}}</option>
                                                        <option value="17">{{__('messages.Västernorrland')}}</option>
                                                        <option value="18">{{__('messages.Västmanland')}}</option>
                                                        <option value="19">{{__('messages.Örebro län')}}</option>
                                                        <option value="20">{{__('messages.Östergötland')}}</option>
                                                        <option value="21">{{__('messages.Götaland')}}</option>
                                                    </select>
                                                    <!-- <input type="text" required="" class="form-control" id="Region" placeholder="Region"> -->
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Name" class="form-label"><span class="font-color-7">*</span>{{__('messages.Name')}}</label>
                                                    <input type="text" required="" class="form-control" id="Name" placeholder="{{__('messages.Name')}}">
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Title" class="form-label">{{__('messages.Title')}}</label>
                                                    <input type="text" required="" class="form-control" id="Title" placeholder="{{__('messages.Position')}}">
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Phone" class="form-label">{{__('messages.Telephone')}}</label>
                                                    <input type="text" class="form-control" id="Phone" placeholder="{{__('messages.Number')}}">
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Email" class="form-label"><span class="font-color-7">*</span>{{__('messages.Email')}}</label>
                                                    <input type="text" class="form-control" id="Email" placeholder="{{__('messages.Email')}}">
                                                </div>
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Title" class="form-label">{{__('messages.Status')}}</label>
                                                    <div class="form-check form-switch form-check-success">
                                                        <input class="form-check-input py-2" type="checkbox" role="switch" id="flexSwitchCheckSuccess">
                                                        <label class="form-check-label user-status-check font-color-7 pt-1" for="flexSwitchCheckSuccess">{{__('messages.Inactive')}}</label>
                                                    </div>
                                                ...
                                                <div class="col-6 col-lg-6 ps-4">
                                                    <label for="Email" class="form-label ps-1">{{__('messages.Last Login')}}</label>
                                    ...
                                    <div class="row user-card__contracts">
                                        <div class="col-sm-12">
                                            <div class="card card-bordered">
                                                <div class="card-body">
                                                    <h5 class="d-flex align-items-center mb-3 font-16">{{__('messages.Responsible For These Contracts')}}</h5>

                                                    <div class="table-responsive bordered">
                                                        <table class="table mb-0 table-striped contracts-list-table">
                                                            <thead class="table-dark">
                                                                <tr>
                                                                    <th class="text-left ps-2"><div class="d-flex justify-content-between align-items-center">{{__('messages.Folder')}}</div></th>
                                                                    <th class="text-left ps-2">{{__('messages.Type')}}</th>
                                                                    <th class="text-left">{{__('messages.Contract')}}</th>
                                                                    <th class="text-left ps-2">{{__('messages.Start Date')}}</th>
                                                                    <th class="text-left">{{__('messages.End Date')}}</th>
                                                                    <th class="text-left ps-2">{{__('messages.Status')}}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
    ...
    $('#twoFactorToggle').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                toastr.success('Two Factor Authentication status updated successfully.');  // Assuming the response has a message
            },
            error: function(xhr) {
                // Show error notification using Toastr
                toastr.error('An error occurred while updating Two Factor Authentication status.');
