				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-end mb-3">
					...
					<div class="ps-3">
				 	...
				 	<div class="ms-auto">
				 		...
				 		<button type="submit" class="btn btn-primary radius-20 mt-2 mt-lg-0 ms-2 px-3">{{ __('users.invite_user') }}</button>
				 	</div>
				</div>
				<div class="col-lg-12">
								...
								<div class="col-lg-5">
									...
									<div class="row g-3 mb-4">
                                        <div class="col-6 col-lg-6 ps-4">
                                            ...
                                            <input type="text" required="" name="company" class="form-control" id="Company" placeholder="Company">
                                        </div>
                                        <div class="col-6 col-lg-6 ps-4">
                                        ...
                                        <div class="col-6 col-lg-6 ps-4">
                                            ...
                                            <input type="text" required=""  name="name" class="form-control" id="Name" placeholder="{{ __('users.fields.name') }}" >
                                        </div>
										<div class="col-6 col-lg-6 ps-4">
                                            <label for="Name" class="form-label"><span class="font-color-7">*</span> {{ __('users.fields.username') }}</label>
                                            <input type="text" required=""  name="username" class="form-control" id="Name" placeholder="{{ __('users.fields.username') }}" >
                                        </div>
                                        <div class="col-6 col-lg-6 ps-4">
                                            <label for="Name" class="form-label"><span class="font-color-7">*</span> {{ __('users.fields.password') }}</label>
                                            <input type="text" required=""  name="password" class="form-control" id="Name" placeholder="{{ __('users.fields.password') }}" >
                                        </div>
                                        <div class="col-6 col-lg-6 ps-4">
                                            <label for="Title" class="form-label">{{ __('users.fields.position') }}</label>
                                            <input type="text" required="" name="position" class="form-control" id="Title" placeholder="{{ __('users.fields.title') }}" >
                                        </div>
                                        <div class="col-6 col-lg-6 ps-4">
                                            <label for="Phone" class="form-label">{{ __('users.fields.telephone') }}</label>
                                            <input type="text" class="form-control" name="telephone" id="Phone" placeholder="{{ __('users.fields.number') }}" >
                                        </div>
                                        <div class="col-6 col-lg-6 ps-4">
                                            <label for="Email" class="form-label"><span class="font-color-7">*</span> {{ __('users.fields.email') }}</label>
                                            <input type="text" class="form-control" name="email" id="Email" placeholder="{{ __('users.fields.email') }}" >
                                        </div>
                                    </div>
								</div>
									...
									<div class="user-permissions-wrapper d-flex flex-column gap-2">
										<div class="user-permissions__header mb-2 user-permissions__values pb-3 pt-3">
											...
											<div class="form-check form-check-inline d-flex align-items-center justify-content-center me-0 gap-2">
		                                        <input class="form-check-input mb-1" type="radio" name="user_type" id="UserType1" value="admin">
		                                    ...
		                                    <div class="form-check form-check-inline d-flex align-items-center justify-content-center me-0 ms-0 ps-0 gap-2">
		                                        <input class="form-check-input mb-1" type="radio" name="user_type" id="UserType2" value="user">
										                ...
										                <div class="permissions-select">
										                    <div class="permissions-select-option" data-value="yes">
										                        <div class="d-flex justify-content-center">
																	<label for="" class="select-button">
																		<input type="checkbox" name="permissions[]" style="display : none" value="create-user">
																	</label>
																	<button type="button" class="select-button" data-index="0" data-value="yes">{{ __('users.permissions_select_yes')}}</button>
																</div>
