                                ...
                                <div class="bs-stepper-header" role="tablist">
                                    <div class="step active" data-target="#test-vl-1">
                                      <div class="step-trigger" role="tab" id="stepper3trigger1" aria-controls="test-vl-1" aria-selected="false" disabled="disabled">
                                        <div class="bs-stepper-circle"><i class="bx bx-user fs-5"></i></div>
                                        <div class="">
                                            <h5 class="mb-0 steper-title">Choose agreement type</h5>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="step" data-target="#test-vl-3">
                                        <div class="step-trigger" role="tab" id="stepper3trigger3" aria-controls="test-vl-3" aria-selected="true">
                                          <div class="bs-stepper-circle"><i class="bx bxs-graduation fs-5"></i></div>
                                          <div class="">
                                    ...
                                    <div class="step" data-target="#test-vl-4">
                                        ...
                                        <div class="bs-stepper-circle"><i class="bx bx-briefcase fs-5"></i></div>
                                        <div class="">
                                            <h5 class="mb-0 steper-title">Attached documents</h5>
                                        </div>
                                        </div>
                                    </div>
                                   </div>
