...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"></i><span class='imageuploadify-message'>Drag And Drop Files Here</span><button type="button"class="btn btn-default">or Browse</button></div><div class="imageuploadify-overlay__validfiles">Valid File Types: .doc, .docx, .xls, .xlsx, .csv, .pdf</div></div>`);
			...
			const readingFile = (id, file) => {
				...
				let container = $(`<div class='imageuploadify-container'><span class="imageuploadify-container__title">Filename</span><button type='button'class='btn btn-danger bx bx-x'></button><div class='imageuploadify-details'><span>${file.name}</span></div></div>`);
				...
				if (file.type && file.type.search(/image/) != -1) {
					...
					fReader.onloadend = function(e) {
						...
						imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+4)").css("margin-left", marginSize + "px");
						imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+3)").css("margin-right", marginSize + "px");
						dragbox.find('.imageuploadify-overlay__validfiles').hide();
					};
				}
			...
			const enableMouseEvents = () => {
				...
				dragbox.css("border-color", "rgb(220 205 255)");
			...
			button.mouseenter(function onMouseEnter(event) {
				button.css("background", "#666871").css("color", "#fff");
			}).mouseleave(function onMouseLeave() {
				button.css("background", "white").css("color", "#65686F");
			});
